...
object Prompt {
    ...
    fun system(): String = buildString {
        ...
        appendLine("Never report done merely because you invoked the capability — the message is not sent")
        appendLine("until you tap send and the app shows it left the compose screen.")
        appendLine()
