...
object Prompt {
    ...
    fun system(): String = buildString {
        ...
        appendLine("to, ALSO return them structured so the OS renders tappable cards (max 3):")
        appendLine("""{"action":"done","summary":"...","places":[{"name":"<display name>",""")
        appendLine(""""detail":"<rating · distance · hours, one line>","query":"<name + area, maps-ready>"}]}""")
